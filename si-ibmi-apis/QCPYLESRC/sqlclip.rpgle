...
// return values
//
dcl-c CLI_SUCCESS const(0);
dcl-c CLI_SUCCESS_WITH_INFO const(1);
dcl-c CLI_NO_DATA_FOUND const(100);
dcl-c CLI_NEED_DATA const(99);
dcl-c CLI_NO_DATA const(100);
dcl-c CLI_ERROR const(-1);
dcl-c CLI_INVALID_HANDLE const(-2);
dcl-c CLI_STILL_EXECUTING const(2);
dcl-c CLI_ROW_SUCCESS const(0);
dcl-c CLI_ROW_NOROW const(-1);

//
// values for SQLFreeStmt
//
dcl-c CLI_CLOSE const(0);
dcl-c CLI_DROP  const(1);
dcl-c CLI_UNBIND const(2);
dcl-c CLI_RESET_PARAMS const(3);

//
//  SQLSetParam defines
//
dcl-c CLI_C_DEFAULT const(99);

//
// SqlEndTran option values
//
dcl-c CLI_COMMIT const(0);
dcl-c CLI_ROLLBACK const(1);
dcl-c CLI_COMMIT_HOLD const(2);
dcl-c CLI_ROLLBACK_HOLD const(3);
dcl-c CLI_SAVEPOINT_NAME_RELEASE const(4);
dcl-c CLI_SAVEPOINT_NAME_ROLLBACK const(5);

//
// SQLDriverConnect option values
//
dcl-c CLI_DRIVER_COMPLETE const(1);
dcl-c CLI_DRIVER_COMPLETE_REQUIRED const(1);
dcl-c CLI_DRIVER_NOPROMPT const(1);
dcl-c CLI_DRIVER_PROMPT const(0);

//
// Valid option codes for GetInfo procedure
//
dcl-c CLI_ACTIVE_CONNECTIONS const(0);
dcl-c CLI_MAX_DRIVER_CONNECTIONS const(0);
dcl-c CLI_MAX_CONCURRENT_ACTIVITIES const(1);
dcl-c CLI_ACTIVE_STATEMENTS const(1);
dcl-c CLI_PROCEDURES const(2);
dcl-c CLI_DRIVER_NAME const(6);
dcl-c CLI_ODBC_API_CONFORMANCE const(9);
dcl-c CLI_ODBC_SQL_CONFORMANCE const(10);
dcl-c CLI_DBMS_NAME const(17);
dcl-c CLI_DBMS_VER const(18);
dcl-c CLI_DRIVER_VER const(18);
dcl-c CLI_IDENTIFIER_CASE const(28);
dcl-c CLI_IDENTIFIER_QUOTE_CHAR const(29);
dcl-c CLI_MAX_COLUMN_NAME_LEN const(30);
dcl-c CLI_MAX_CURSOR_NAME_LEN const(31);
dcl-c CLI_MAX_OWNER_NAME_LEN const(32);
dcl-c CLI_MAX_SCHEMA_NAME_LEN const(33);
dcl-c CLI_MAX_TABLE_NAME_LEN const(35);
dcl-c CLI_MAX_COLUMNS_IN_GROUP_BY const(36);
dcl-c CLI_MAX_COLUMNS_IN_ORDER_BY const(37);
dcl-c CLI_MAX_COLUMNS_IN_SELECT const(38);
dcl-c CLI_MAX_COLUMNS_IN_TABLE const(39);
dcl-c CLI_MAX_TABLES_IN_SELECT const(40);
dcl-c CLI_COLUMN_ALIAS const(41);
dcl-c CLI_DATA_SOURCE_NAME const(42);
dcl-c CLI_DATABASE_NAME const(42);
dcl-c CLI_MAX_COLUMNS_IN_INDEX const(43);
dcl-c CLI_PROCEDURE_TERM const(44);
dcl-c CLI_QUALIFIER_TERM const(45);
dcl-c CLI_TXN_CAPABLE const(46);
dcl-c CLI_OWNER_TERM const(47);
dcl-c CLI_DATA_SOURCE_READ_ONLY const(48);
dcl-c CLI_DEFAULT_TXN_ISOLATION const(49);
dcl-c CLI_MULTIPLE_ACTIVE_TXN const(55);
dcl-c CLI_QUALIFIER_NAME_SEPARATOR const(65);
dcl-c CLI_CORRELATION_NAME const(74);
dcl-c CLI_NON_NULLABLE_COLUMNS const(75);
dcl-c CLI_DRIVER_ODBC_VER const(77);
dcl-c CLI_GROUP_BY const(88);
dcl-c CLI_ORDER_BY_COLUMNS_IN_SELECT const(90);
dcl-c CLI_OWNER_USAGE const(91);
dcl-c CLI_QUALIFIER_USAGE const(92);
dcl-c CLI_QUOTED_IDENTIFIER_CASE const(93);
dcl-c CLI_MAX_ROW_SIZE const(104);
dcl-c CLI_QUALIFIER_LOCATION const(114);
dcl-c CLI_MAX_CATALOG_NAME_LEN const(115);
dcl-c CLI_MAX_STATEMENT_LEN const(116);
dcl-c CLI_SEARCH_PATTERN_ESCAPE const(117);
dcl-c CLI_OUTER_JOINS const(118);
dcl-c CLI_LIKE_ESCAPE_CLAUSE const(119);
dcl-c CLI_CATALOG_NAME const(120);
dcl-c CLI_DESCRIBE_PARAMETER const(121);
dcl-c CLI_STRING_FUNCTIONS const(50);
dcl-c CLI_NUMERIC_FUNCTIONS const(51);
dcl-c CLI_CONVERT_FUNCTIONS const(52);
dcl-c CLI_TIMEDATE_FUNCTIONS const(53);
dcl-c CLI_SQL92_PREDICATES const(160);
dcl-c CLI_SQL92_VALUE_EXPRESSIONS const(165);
dcl-c CLI_AGGREGATE_FUNCTIONS const(169);
dcl-c CLI_SQL_CONFORMANCE const(170);
dcl-c CLI_CONVERT_CHAR const(171);
dcl-c CLI_CONVERT_NUMERIC const(172);
dcl-c CLI_CONVERT_DECIMAL const(173);
dcl-c CLI_CONVERT_INTEGER const(174);
dcl-c CLI_CONVERT_SMALLINT const(175);
dcl-c CLI_CONVERT_FLOAT const(176);
dcl-c CLI_CONVERT_REAL const(177);
dcl-c CLI_CONVERT_DOUBLE const(178);
dcl-c CLI_CONVERT_VARCHAR const(179);
dcl-c CLI_CONVERT_LONGVARCHAR const(180);
dcl-c CLI_CONVERT_BINARY const(181);
dcl-c CLI_CONVERT_VARBINARY const(182);
dcl-c CLI_CONVERT_BIT const(183);
dcl-c CLI_CONVERT_TINYINT const(184);
dcl-c CLI_CONVERT_BIGINT const(185);
dcl-c CLI_CONVERT_DATE const(186);
dcl-c CLI_CONVERT_TIME const(187);
dcl-c CLI_CONVERT_TIMESTAMP const(188);
dcl-c CLI_CONVERT_LONGVARBINARY const(189);
dcl-c CLI_CONVERT_INTERVAL_YEAR_MONTH const(190);
dcl-c CLI_CONVERT_INTERVAL_DAY_TIME const(191);
dcl-c CLI_CONVERT_WCHAR const(192);
dcl-c CLI_CONVERT_WLONGVARCHAR const(193);
dcl-c CLI_CONVERT_WVARCHAR const(194);
dcl-c CLI_CONVERT_BLOB const(195);
dcl-c CLI_CONVERT_CLOB const(196);
dcl-c CLI_CONVERT_DBCLOB const(197);
dcl-c CLI_CURSOR_COMMIT_BEHAVIOR const(198);
dcl-c CLI_CURSOR_ROLLBACK_BEHAVIOR const(199);
dcl-c CLI_POSITIONED_STATEMENTS const(200);
dcl-c CLI_KEYWORDS const(201);
dcl-c CLI_CONNECTION_JOB_NAME const(202);

//
// Aliased option codes (ODBC 3.0)
//
dcl-c CLI_SCHEMA_TERM const(47);
dcl-c CLI_SCHEMA_USAGE const(91);
dcl-c CLI_CATALOG_LOCATION const(114);
dcl-c CLI_CATALOG_TERM const(45);
dcl-c CLI_CATALOG_USAGE const(92);
dcl-c CLI_CATALOG_NAME_SEPARATOR const(65);

//
// Output values for SQL_ODBC_API_CONFORMANCE
// info type in SQLGetInfo
//
dcl-c CLI_OAC_NONE const(0);
dcl-c CLI_OAC_LEVEL1 const(1);
dcl-c CLI_OAC_LEVEL2 const(2);

//
// Output values for SQL_ODBC_SQL_CONFORMANCE
// info type in SQLGetInfo
//
dcl-c CLI_OSC_MINIMUM const(0);
dcl-c CLI_OSC_CORE const(1);
dcl-c CLI_OSC_EXTENDED const(2);

//
// Output values for SQL_QUALIFIER_USAGE
// info type in SQLGetInfo
//
dcl-c CLI_QU_NOT_SUPPORTED const(x'00000000');
dcl-c CLI_QU_DML_STATEMENTS const(x'00000001');
dcl-c CLI_QU_PROCEDURE_INVOCATION const(x'00000002');
dcl-c CLI_QU_TABLE_DEFINITION const(x'00000004');
dcl-c CLI_QU_INDEX_DEFINITION const(x'00000008');
dcl-c CLI_QU_PRIVILEGE_DEFINITION const(x'00000010');

//
// Output values for SQL_QUALIFIER_LOCATION
// info type in SQLGetInfo
//
dcl-c CLI_QL_START const(1);
dcl-c CLI_QL_END const(2);

//
// Output values for SQL_OWNER_USAGE
// info type in SQLGetInfo
//
dcl-c CLI_OU_DML_STATEMENTS const(x'00000001');
dcl-c CLI_OU_PROCEDURE_INVOCATION const(x'00000002');
dcl-c CLI_OU_TABLE_DEFINITION const(x'00000004');
dcl-c CLI_OU_INDEX_DEFINITION const(x'00000008');
dcl-c CLI_OU_PRIVILEGE_DEFINITION const( x'00000010');

//
// Output values for SQL_TXN_CAPABLE
// info type in SQLGetInfo
//
dcl-c CLI_TC_NONE const(0);
dcl-c CLI_TC_DML const(1);
dcl-c CLI_TC_ALL const(2);
dcl-c CLI_TC_DDL_COMMIT const(3);
dcl-c CLI_TC_DDL_IGNORE const(4);
...
// info type in SQLGetInfo
//
dcl-c CLI_CN_NONE const(0);
dcl-c CLI_CN_DIFFERENT const(1);
dcl-c CLI_CN_ANY const(2);

//
// Output values for SQL_IDENTIFIER_CASE
// info type in SQLGetInfo
//
dcl-c CLI_IC_UPPER const(1);
dcl-c CLI_IC_LOWER const(2);
dcl-c CLI_IC_SENSITIVE const(3);
dcl-c CLI_IC_MIXED const(4);

//
// Output values for SQL_NON_NULLABLE_COLUMNS
// info type in SQLGetInfo
//
dcl-c CLI_NNC_NULL const(0);
dcl-c CLI_NNC_NON_NULL const(1);

//
// Output values for SQL_GROUP_BY
// info type in SQLGetInfo
//
dcl-c CLI_GB_NO_RELATION const(0);
dcl-c CLI_GB_NOT_SUPPORTED const(1);
dcl-c CLI_GB_GROUP_BY_EQUALS_SELECT const(2);
dcl-c CLI_GB_GROUP_BY_CONTAINS_SELECT const(3);

//
// Standard SQL data types
//
dcl-c CLI_CHAR     const(1);
dcl-c CLI_NUMERIC  const(2);
dcl-c CLI_DECIMAL  const(3);
dcl-c CLI_INTEGER  const(4);
dcl-c CLI_SMALLINT const(5);
dcl-c CLI_FLOAT    const(6);
dcl-c CLI_REAL     const(7);
dcl-c CLI_DOUBLE   const(8);
dcl-c CLI_DATETIME const(9);
dcl-c CLI_VARCHAR  const(12);
dcl-c CLI_BLOB     const(13);
dcl-c CLI_CLOB     const(14);
dcl-c CLI_DBCLOB   const(15);
dcl-c CLI_DATALINK const(16);
dcl-c CLI_WCHAR    const(17);
dcl-c CLI_WUARCHAR const(18);
dcl-c CLI_BIGINT   const(19);
dcl-c CLI_BLOB_LOCATOR const(20);
dcl-c CLI_CLOB_LOCATOR const(21);
dcl-c CLI_DBCLOB_LOCATOR const(22);
dcl-c CLI_UTF8_CHAR const(23);
dcl-c CLI_GRAPHIC  const(95);
dcl-c CLI_VARGRAPHIC const(96);
dcl-c CLI_BINARY   const(97);
dcl-c CLI_VARBINARY const(98);
dcl-c CLI_DATE     const(91);
dcl-c CLI_TYPE_DATE const(91);
dcl-c CLI_TIME     const(92);
dcl-c CLI_TYPE_TIME const(92);
dcl-c CLI_TIMESTAMP const(93);
dcl-c CLI_TYPE_TIMESTAMP const(93);
dcl-c CLI_ALL_TYPES const(0);
//
// Output values for cursor behavior
//
dcl-c CLI_CB_DELETE const(1);
dcl-c CLI_CB_CLOSE const(2);
dcl-c CLI_CB_PRESERVE const(3);
...
// Handle types
//
dcl-c CLI_UNUSED const(0);
dcl-c CLI_HANDLE_ENV const(1);
dcl-c CLI_HANDLE_DBC const(2);
dcl-c CLI_HANDLE_STMT const(3);
dcl-c CLI_HANDLE_DESC const(4);
dcl-c CLI_NULL_HANDLE const(0);
dcl-c CLI_HANDLE_DBC_UNICODE const(100);
...
//  in a table.
//
dcl-c CLI_NO_NULLS const(0);
dcl-c CLI_NULLABLE const(1);
dcl-c CLI_NULLABLE_UNKNOWN const(2);

//
// Special length values
//
dcl-c CLI_NO_TOTAL const(0);
dcl-c CLI_NULL_DATA const(-1);
dcl-c CLI_DATA_AT_EXEC const(-2);
dcl-c CLI_BIGINT_PREC const(19);
dcl-c CLI_INTEGER_PREC const(10);
dcl-c CLI_SMALLINT_PREC const(5);

//
// SQLColAttributes constants
//
dcl-c CLI_ATTR_READONLY const(0);
dcl-c CLI_ATTR_WRITE const(1);
dcl-c CLI_ATTR_READWRITE_UNKNOWN const(2);

//
// Valid concurrency values
//
dcl-c CLI_CONCUR_LOCK const(0);
dcl-c CLI_CONCUR_READ_ONLY const(1);
dcl-c CLI_CONCUR_ROWVER const(3);
dcl-c CLI_CONCUR_VALUES const(4);

//
// Valid environment attributes
//
dcl-c CLI_ATTR_OUTPUT_NTS const(10001);
dcl-c CLI_ATTR_SYS_NAMING const(10002);
dcl-c CLI_ATTR_DEFAULT_LIB const(10003);
dcl-c CLI_ATTR_SERVER_MODE const(10004);
dcl-c CLI_ATTR_JOB_SORT_SEQUENCE const(10005);
dcl-c CLI_ATTR_ENVHNDL_COUNTER const(10009);
dcl-c CLI_ATTR_ESCAPE_CHAR const(10010);
dcl-c CLI_ATTR_INCLUDE_NULL_IN_LEN const(10031);
dcl-c CLI_ATTR_UTF8 const(10032);
dcl-c CLI_ATTR_SYSCAP const(10033);
dcl-c CLI_ATTR_REQUIRE_PROFILE const(10034);
dcl-c CLI_ATTR_UCS2 const(10035);
dcl-c CLI_ATTR_TRUNCATION_RTNC const(10036);

//
// Valid environment/connection attributes
//
dcl-c CLI_ATTR_EXTENDED_COL_INFO const(10019);
dcl-c CLI_ATTR_DATE_FMT const(10020);
dcl-c CLI_ATTR_DATE_SEP const(10021);
dcl-c CLI_ATTR_TIME_FMT const(10022);
dcl-c CLI_ATTR_TIME_SEP const(10023);
dcl-c CLI_ATTR_DECIMAL_SEP const(10024);
dcl-c CLI_ATTR_TXN_INFO const(10025);
dcl-c CLI_ATTR_TXN_EXTERNAL const(10026);
dcl-c CLI_ATTR_2ND_LEVEL_TEXT const(10027);
dcl-c CLI_ATTR_SAVEPOINT_NAME const(10028);
dcl-c CLI_ATTR_TRACE const(10029);
dcl-c CLI_ATTR_MAX_PRECISION const(10040);
dcl-c CLI_ATTR_MAX_SCALE const(10041);
dcl-c CLI_ATTR_MIN_DIVIDE_SCALE const(10042);
dcl-c CLI_ATTR_HEX_LITERALS const(10043);
dcl-c CLI_ATTR_CORRELATOR const(10044);

//
// Valid transaction info operations
//
dcl-c CLI_TXN_FIND const(1);
dcl-c CLI_TXN_CREATE const( 2);
dcl-c CLI_TXN_CLEAR const(3);
dcl-c CLI_TXN_END const(4);
dcl-c CLI_TXN_HOLD const(5);

//
// Valid environment/connection values
//
dcl-c CLI_FMT_ISO const(1);
dcl-c CLI_FMT_USA const(2);
dcl-c CLI_FMT_EUR const(3);
dcl-c CLI_FMT_JIS const(4);
dcl-c CLI_FMT_MDY const(5);
dcl-c CLI_FMT_DMY const(6);
dcl-c CLI_FMT_YMD const(7);
dcl-c CLI_FMT_JUL const(8);
dcl-c CLI_FMT_HMS const(9);
dcl-c CLI_FMT_JOB const(10);
dcl-c CLI_SEP_SLASH const(1);
dcl-c CLI_SEP_DASH const(2);
dcl-c CLI_SEP_PERIOD const(3);
dcl-c CLI_SEP_COMMA const(4);
dcl-c CLI_SEP_BLANK const(5);
dcl-c CLI_SEP_COLON const(6);
dcl-c CLI_SEP_JOB const(7);
dcl-c CLI_HEX_IS_CHAR const(1);
dcl-c CLI_HEX_IS_BINARY const(2);

//
// Valid values for type in GetCol
//
dcl-c CLI_DEFAULT const(99);
dcl-c CLI_ARD_TYPE const(-99);

//
// Valid values for UPDATE_RULE and DELETE_RULE in SQLForeignKeys
//
dcl-c CLI_CASCADE const(1);
dcl-c CLI_RESTRICT const(2);
dcl-c CLI_NO_ACTION const(3);
dcl-c CLI_SET_NULL const(4);
dcl-c CLI_SET_DEFAULT const(5);

//
// Valid values for COLUMN_TYPE in SQLProcedureColumns
//
dcl-c CLI_PARAM_INPUT const(1);
dcl-c CLI_PARAM_OUTPUT const(2);
dcl-c CLI_PARAM_INPUT_OUTPUT const(3);

//
// Statement attributes
//
dcl-c CLI_ATTR_APP_ROW_DESC const(10010);
dcl-c CLI_ATTR_APP_PARAM_DESC const(10011);
dcl-c CLI_ATTR_IMP_ROW_DESC const(10012);
dcl-c CLI_ATTR_IMP_PARAM_DESC const(10013);
dcl-c CLI_ATTR_FOR_FETCH_ONLY const(10014);
dcl-c CLI_ATTR_CONCURRENCY const(10014);
dcl-c CLI_CONCURRENCY const(10014);
dcl-c CLI_ATTR_CURSOR_SCROLLABLE const(10015);
dcl-c CLI_ATTR_ROWSET_SIZE const(10016);
dcl-c CLI_ROWSET_SIZE const(10016);
dcl-c CLI_ATTR_ROW_ARRAY_SIZE const(10016);
dcl-c CLI_ATTR_CURSOR_HOLD const(10017);
dcl-c CLI_ATTR_FULL_OPEN const(10018);
dcl-c CLI_ATTR_BIND_TYPE const(10049);
dcl-c CLI_BIND_TYPE const(10049);
dcl-c CLI_ATTR_CURSOR_TYPE const(10050);
dcl-c CLI_CURSOR_TYPE const(10050);
dcl-c CLI_ATTR_CURSOR_SENSITIVITY const(10051);
dcl-c CLI_CURSOR_SENSITIVE const(10051);

//
// Values for setting statement attributes
//
dcl-c CLI_BIND_BY_ROW const(0);
dcl-c CLI_BIND_BY_COLUMN const(1);
dcl-c CLI_CURSOR_FORWARD_ONLY const(0);
dcl-c CLI_CURSOR_STATIC const(1);
dcl-c CLI_CURSOR_DYNAMIC const(2);
dcl-c CLI_CURSOR_KEYSET_DRIVEN const(3);
dcl-c CLI_UNSPECIFIED const(0);
dcl-c CLI_INSENSITIVE const(1);
dcl-c CLI_SENSITIVE const(2);

//
// Codes used in SQLFetchScroll and SQLExtendedFetch
//
dcl-c CLI_FETCH_NEXT const(1);
dcl-c CLI_FETCH_FIRST const(2);
dcl-c CLI_FETCH_LAST const(3);
dcl-c CLI_FETCH_PRIOR const(4);
dcl-c CLI_FETCH_ABSOLUTE const(5);
dcl-c CLI_FETCH_RELATIVE const(6);

//
// SQLColAttributes constants
//
dcl-c CLI_DESC_COUNT const(1);
dcl-c CLI_DESC_TYPE const(2);
dcl-c CLI_DESC_LENGTH const(3);
dcl-c CLI_DESC_LENGTH_PTR const(4);
dcl-c CLI_DESC_PRECISION const(5);
dcl-c CLI_DESC_SCALE const(6);
dcl-c CLI_DESC_DATETIME_INTERVAL_CODE const(7);
dcl-c CLI_DESC_NULLABLE const(8);
dcl-c CLI_DESC_INDICATOR_PTR const(9);
dcl-c CLI_DESC_DATA_PTR const(10);
dcl-c CLI_DESC_NAME const(11);
dcl-c CLI_DESC_UNNAMED const(12);
dcl-c CLI_DESC_DISPLAY_SIZE const(13);
dcl-c CLI_DESC_AUTO_INCREMENT const(14);
dcl-c CLI_DESC_SEARCHABLE const(15);
dcl-c CLI_DESC_UPDATABLE const(16);
dcl-c CLI_DESC_BASE_COLUMN const(17);
dcl-c CLI_DESC_BASE_TABLE const(18);
dcl-c CLI_DESC_BASE_SCHEMA const(19);
dcl-c CLI_DESC_LABEL const(20);
dcl-c CLI_DESC_MONEY const(21);
dcl-c CLI_DESC_ALLOC_TYPE const(99);
dcl-c CLI_DESC_ALLOC_AUTO const(1);
dcl-c CLI_DESC_ALLOC_USER const(2);

dcl-c CLI_COLUMN_COUNT const(1);
dcl-c CLI_COLUMN_TYPE const(2);
dcl-c CLI_COLUMN_LENGTH const(3);
dcl-c CLI_COLUMN_LENGTH_PTR const(4);
dcl-c CLI_COLUMN_PRECISION const(5);
dcl-c CLI_COLUMN_SCALE const(6);
dcl-c CLI_COLUMN_DATETIME_INTERVAL_CODE const(7);
dcl-c CLI_COLUMN_NULLABLE const(8);
dcl-c CLI_COLUMN_INDICATOR_PTR const(9);
dcl-c CLI_COLUMN_DATA_PTR const(10);
dcl-c CLI_COLUMN_NAME const(11);
dcl-c CLI_COLUMN_UNNAMED const(12);
dcl-c CLI_COLUMN_DISPLAY_SIZE const(13);
dcl-c CLI_COLUMN_AUTO_INCREMENT const(14);
dcl-c CLI_COLUMN_SEARCHABLE const(15);
dcl-c CLI_COLUMN_UPDATABLE const(16);
dcl-c CLI_COLUMN_BASE_COLUMN const(17);
dcl-c CLI_COLUMN_BASE_TABLE const(18);
dcl-c CLI_COLUMN_BASE_SCHEMA const(19);
dcl-c CLI_COLUMN_LABEL const(20);
dcl-c CLI_COLUMN_MONEY const(21);
dcl-c CLI_COLUMN_ALLOC_TYPE const(99);
dcl-c CLI_COLUMN_ALLOC_AUTO const(1);
dcl-c CLI_COLUMN_ALLOC_USER const(2);

//
// Valid codes for SpecialColumns procedure
//
dcl-c CLI_SCOPE_CURROW const(0);
dcl-c CLI_SCOPE_TRANSACTION const(1);
dcl-c CLI_SCOPE_SESSION const(2);
dcl-c CLI_PC_UNKNOWN const(0);
dcl-c CLI_PC_NOT_PSEUDO const(1);
dcl-c CLI_PC_PSEUDO const(2);

//
// Valid values for connect attribute
//
dcl-c CLI_ATTR_AUTO_IPD const( 10001);
dcl-c CLI_ATTR_ACCESS_MODE const( 10002 );
dcl-c CLI_ACCESS_MODE const( 10002);
dcl-c CLI_ATTR_AUTOCOMMIT const( 10003);
dcl-c CLI_AUTOCOMMIT const( 10003);
dcl-c CLI_ATTR_DBC_SYS_NAMING const( 10004);
dcl-c CLI_ATTR_DBC_DEFAULT_LIB const( 10005);
dcl-c CLI_ATTR_ADOPT_OWNER_AUTH const( 10006);
dcl-c CLI_ATTR_SYSBAS_CMT const( 10007);
dcl-c CLI_ATTR_COMMIT const( 0);
dcl-c CLI_MODE_READ_ONLY const( 0);
dcl-c CLI_MODE_READ_WRITE const( 1);
dcl-c CLI_MODE_DEFAULT const( 1);
dcl-c CLI_AUTOCOMMIT_OFF const( 0);
dcl-c CLI_AUTOCOMMIT_ON const( 1);
dcl-c CLI_TXN_ISOLATION const( 0);
dcl-c CLI_ATTR_TXN_ISOLATION const( 0);
dcl-c CLI_COMMIT_NONE const( 1);
dcl-c CLI_TXN_NO_COMMIT const( 1);
dcl-c CLI_TXN_NOCOMMIT const( 1);
dcl-c CLI_COMMIT_CHG const( 2);
dcl-c CLI_COMMIT_UR const( 2);
dcl-c CLI_TXN_READ_UNCOMMITTED const( 2);
dcl-c CLI_COMMIT_CS const(3);
dcl-c CLI_TXN_READ_COMMITTED const(3);
dcl-c CLI_COMMIT_ALL const(4);
dcl-c CLI_COMMIT_RS const(4);
dcl-c CLI_TXN_REPEATABLE_READ const(4);
dcl-c CLI_COMMIT_RR const(5);
dcl-c CLI_TXN_SERIALIZABLE const(5);

//
// Valid index flags
//
dcl-c CLI_INDEX_UNIQUE const( 0);
dcl-c CLI_INDEX_ALL const( 1);
dcl-c CLI_INDEX_OTHER const( 3);
dcl-c CLI_TABLE_STAT const( 0);
dcl-c CLI_ENSURE const( 1);
dcl-c CLI_QUICK const( 0);

//
// Valid trace values
//
dcl-c CLI_ATTR_TRACE_CLI const( 1);
dcl-c CLI_ATTR_TRACE_DBMON const( 2);
dcl-c CLI_ATTR_TRACE_DEBUG const( 4);
dcl-c CLI_ATTR_TRACE_JOBLOG const( 8);
dcl-c CLI_ATTR_TRACE_STRTRC const( 16);

//
// Valid file options
//
dcl-c CLI_FILE_READ const( 2);
dcl-c CLI_FILE_CREATE const( 8);
dcl-c CLI_FILE_OVERWRITE const( 16);
dcl-c CLI_FILE_APPEND const( 32);
dcl-c CLI_DIAG_RETURNCODE const( 1);
dcl-c CLI_DIAG_NUMBER const( 2);

//
// Valid types for GetDiagField
//
dcl-c CLI_DIAG_ROW_COUNT const( 3);
dcl-c CLI_DIAG_SQLSTATE const( 4);
dcl-c CLI_DIAG_NATIVE const( 5);
dcl-c CLI_DIAG_MESSAGE_TEXT const( 6);
dcl-c CLI_DIAG_DYNAMIC_FUNCTION const( 7);
dcl-c CLI_DIAG_CLASS_ORIGIN const( 8);
dcl-c CLI_DIAG_SUBCLASS_ORIGIN const( 9);
dcl-c CLI_DIAG_CONNECTION_NAME const( 10);
dcl-c CLI_DIAG_SERVER_NAME const( 11);
dcl-c CLI_DIAG_MESSAGE_TOKENS const( 12);
dcl-c CLI_DIAG_AUTOGEN_KEY const( 14);

//
// SQLColAttributes constants
// These are also used by SQLGetInfo
//
dcl-c CLI_UNSEARCHABLE const( 0);
dcl-c CLI_LIKE_ONLY const( 1);
dcl-c CLI_ALL_EXCEPT_LIKE const( 2);
dcl-c CLI_SEARCHABLE const( 3);

//
// GetFunctions() values to identify CLI functions
//
dcl-c CLI_API_SQLALLOCCONNECT const( 1);
dcl-c CLI_API_SQLALLOCENV const( 2);
dcl-c CLI_API_SQLALLOCHANDLE const( 1001);
dcl-c CLI_API_SQLALLOCSTMT const( 3);
dcl-c CLI_API_SQLBINDCOL const( 4);
dcl-c CLI_API_SQLBINDFILETOCOL const( 2002);
dcl-c CLI_API_SQLBINDFILETOPARAM const( 2003);
dcl-c CLI_API_SQLBINDPARAM const( 1002);
dcl-c CLI_API_SQLBINDPARAMETER const( 1023);
dcl-c CLI_API_SQLCANCEL const( 5);
dcl-c CLI_API_SQLCLOSECURSOR const( 1003);
dcl-c CLI_API_SQLCOLATTRIBUTES const( 6);
dcl-c CLI_API_SQLCOLUMNPRIVILEGES const( 2010);
dcl-c CLI_API_SQLCOLUMNS const( 40);
dcl-c CLI_API_SQLCONNECT const( 7);
dcl-c CLI_API_SQLCOPYDESC const( 1004);
dcl-c CLI_API_SQLDATASOURCES const( 57);
dcl-c CLI_API_SQLDESCRIBECOL const( 8);
dcl-c CLI_API_SQLDESCRIBEPARAM const( 58);
dcl-c CLI_API_SQLDISCONNECT const( 9);
dcl-c CLI_API_SQLDRIVERCONNECT const( 68);
dcl-c CLI_API_SQLENDTRAN const( 1005);
dcl-c CLI_API_SQLERROR const( 10);
dcl-c CLI_API_SQLEXECDIRECT const( 11);
dcl-c CLI_API_SQLEXECUTE const( 12);
dcl-c CLI_API_SQLEXTENDEDFETCH const( 1022);
dcl-c CLI_API_SQLFETCH const( 13);
dcl-c CLI_API_SQLFETCHSCROLL const( 1021);
dcl-c CLI_API_SQLFOREIGNKEYS const( 60);
dcl-c CLI_API_SQLFREECONNECT const( 14);
dcl-c CLI_API_SQLFREEENV const( 15);
dcl-c CLI_API_SQLFREEHANDLE const( 1006);
dcl-c CLI_API_SQLFREESTMT const( 16);
dcl-c CLI_API_SQLGETCOL const( 43);
dcl-c CLI_API_SQLGETCONNECTATTR const( 1007);
dcl-c CLI_API_SQLGETCONNECTOPTION const( 42);
dcl-c CLI_API_SQLGETCURSORNAME const( 17);
dcl-c CLI_API_SQLGETDATA const( 43);
dcl-c CLI_API_SQLGETDESCFIELD const( 1008);
dcl-c CLI_API_SQLGETDESCREC const( 1009);
dcl-c CLI_API_SQLGETDIAGFIELD const( 1010);
dcl-c CLI_API_SQLGETDIAGREC const( 1011);
dcl-c CLI_API_SQLGETENVATTR const( 1012);
dcl-c CLI_API_SQLGETFUNCTIONS const( 44);
dcl-c CLI_API_SQLGETINFO const( 45);
dcl-c CLI_API_SQLGETLENGTH const( 2004);
dcl-c CLI_API_SQLGETPOSITION const( 2005);
dcl-c CLI_API_SQLGETSTMTATTR const( 1014);
dcl-c CLI_API_SQLGETSTMTOPTION const( 46);
dcl-c CLI_API_SQLGETSUBSTRING const( 2006);
dcl-c CLI_API_SQLGETTYPEINFO const( 47);
dcl-c CLI_API_SQLLANGUAGES const( 2001);
dcl-c CLI_API_SQLMORERESULTS const( 61);
dcl-c CLI_API_SQLNATIVESQL const( 62);
dcl-c CLI_API_SQLNEXTRESULT const( 2009);
dcl-c CLI_API_SQLNUMPARAMS const( 63);
dcl-c CLI_API_SQLNUMRESULTCOLS const( 18);
dcl-c CLI_API_SQLPARAMDATA const( 48);
dcl-c CLI_API_SQLPARAMOPTIONS const( 2007);
dcl-c CLI_API_SQLPREPARE const( 19);
dcl-c CLI_API_SQLPRIMARYKEYS const( 65);
dcl-c CLI_API_SQLPROCEDURECOLUMNS const( 66);
dcl-c CLI_API_SQLPROCEDURES const( 67);
dcl-c CLI_API_SQLPUTDATA const( 49);
dcl-c CLI_API_SQLRELEASEENV const( 1015);
dcl-c CLI_API_SQLROWCOUNT const( 20);
dcl-c CLI_API_SQLSETCONNECTATTR const( 1016);
dcl-c CLI_API_SQLSETCONNECTOPTION const( 50);
dcl-c CLI_API_SQLSETCURSORNAME const( 21);
dcl-c CLI_API_SQLSETDESCFIELD const( 1017);
dcl-c CLI_API_SQLSETDESCREC const( 1018);
dcl-c CLI_API_SQLSETENVATTR const( 1019);
dcl-c CLI_API_SQLSETPARAM const( 22);
dcl-c CLI_API_SQLSETSTMTATTR const( 1020);
dcl-c CLI_API_SQLSETSTMTOPTION const( 51);
dcl-c CLI_API_SQLSPECIALCOLUMNS const( 52);
dcl-c CLI_API_SQLSTARTTRAN const( 2008);
dcl-c CLI_API_SQLSTATISTICS const( 53);
dcl-c CLI_API_SQLTABLEPRIVILEGES const( 2011);
dcl-c CLI_API_SQLTABLES const( 54);
dcl-c CLI_API_SQLTRANSACT const( 23);

//
// NULL handle constants
//
dcl-c CLI_NULL_HENV const( 0);
dcl-c CLI_NULL_HDBC const( 0);
dcl-c CLI_NULL_HSTMT const( 0);

//
// truncated values return this sqlstate
//
dcl-c CLI_WARN_VAL_TRUNC const( '01004');
